...
rm_2box<-matrix(0,nrow=5,ncol=2)
rm_2box[1,] = c(10.0/3, 0.76)#!user 200k
#rm_2box[2,] = c(20.0/3, 3.38)#!user 400k
#rm_2box[3,] = c(30.0/3, 3.01)#!user 600k
#rm_2box[4,] = c(40.0/3, 2.86) #!user 800k
#rm_2box[5,] = c(50.0/3, 3.01) #!user 1000k
